...
def extract_menu_from_html(html):
    ...
    # Ta bort element med navigation-klasser (undvik att ta bort faktiskt menyinnehåll)
    nav_patterns = ['nav-', 'navbar', 'navigation', 'header-nav', 'footer', 'sidebar', 'social', 'cookie', 'popup']
